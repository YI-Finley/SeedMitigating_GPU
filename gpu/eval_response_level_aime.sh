...
OUTPUT_BASE="$SEEDMIT_OUTPUT_BASE/evaluation/response_level"
CHECKPOINT_BASE="$SEEDMIT_OUTPUT_BASE/checkpoints"

DATASETS=(aime_2024 aime_2025)
MODELS=(qwen3_instruct baseline_ppo confidence_brier confidence_ce ppo_value)
