...
def _default_attn_implementation() -> str:
    forced_impl = os.getenv("VERL_ATTN_IMPLEMENTATION")
    if forced_impl:
        return forced_impl

    if os.getenv("VLLM_DEVICE", "").lower() == "npu" or os.getenv("ACCELERATE_TORCH_DEVICE", "").lower() == "npu":
        return "sdpa"
...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        attn_implementation = override_model_config.get("attn_implementation", _default_attn_implementation())
...
class CriticWorker(Worker, DistProfilerExtension):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        # override model kwargs
        attn_implementation = override_config.get("attn_implementation", _default_attn_implementation())
