...
RESUME_ROOT="/root/code/SeedMitigating/output/checkpoints/Qwen3-4B-Instruct-Explicit-Risk-20260204_144342"
RESUME_DIR="${RESUME_ROOT}/global_step_20"
