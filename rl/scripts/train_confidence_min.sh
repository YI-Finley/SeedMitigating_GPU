#!/bin/bash
# 训练脚本: Qwen3-4B-Instruct-Confidence-Min
# 描述: 声明级置信度 + 最小值聚合
# 对应论文: Section 3.3 - Claim-level Calibration (Minimum Aggregation)
...
# 输出目录
OUTPUT_DIR="/data2/SeedMitigating-output/paper_reproduction/checkpoints/confidence_min"
rm -f "$OUTPUT_DIR/TRAINING_DONE"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "训练: Qwen3-4B-Instruct-Confidence-Min"
echo "=========================================="
echo "策略: 声明级置信度 + 最小值聚合"
echo "奖励: R = 2(min p_i)·valid(y) - (min p_i)²"
echo "聚合方式: Minimum"
echo "输出: $OUTPUT_DIR"
...
python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.name=compute_score_claim_minimum \
    trainer.logger='["console","wandb"]' \
    trainer.project_name=behavioral_calibration_paper \
    trainer.experiment_name=confidence_min \
