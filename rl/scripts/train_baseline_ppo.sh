#!/bin/bash
# 训练脚本: Qwen3-4B-Instruct-PPO (Baseline)
# 描述: 标准PPO训练，使用二元正确性奖励（+1正确，-1错误）
...
# 输出目录
OUTPUT_DIR="/data2/SeedMitigating-output/paper_reproduction/checkpoints/baseline_ppo"
rm -f "$OUTPUT_DIR/TRAINING_DONE"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "训练: Qwen3-4B-Instruct-PPO (Baseline)"
echo "=========================================="
echo "策略: 标准PPO + 二元奖励"
echo "奖励: +1 (正确), -1 (错误)"
echo "输出: $OUTPUT_DIR"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=baseline_ppo \
