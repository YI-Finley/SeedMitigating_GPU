#!/bin/bash
# 训练脚本: Qwen3-4B-Instruct-PPO-Value
...
# 输出目录
OUTPUT_DIR="/data2/SeedMitigating-output/paper_reproduction/checkpoints/ppo_value"
rm -f "$OUTPUT_DIR/TRAINING_DONE"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "训练: Qwen3-4B-Instruct-PPO-Value"
echo "=========================================="
echo "策略: PPO训练（与Baseline一致），评估时使用Critic Value作为置信度"
echo "奖励: 标准二元正确性奖励"
echo "特点: 无需额外置信度token"
echo "输出: $OUTPUT_DIR"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=ppo_value \
